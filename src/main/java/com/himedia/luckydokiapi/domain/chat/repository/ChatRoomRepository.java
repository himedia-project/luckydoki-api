...
public interface ChatRoomRepository extends JpaRepository<ChatRoom, Long> {
    ...
    @Query("SELECT c FROM ChatRoom c WHERE c.member.email = :email OR c.shop.member.email = :email ORDER BY c.lastMessageTime asc")
    List<ChatRoom> findByMemberOrShopMemberOrderByLastMessageTimeAsc(String email);
