...
public class ChatMessage {
    ...
    private Long senderId;      // 메시지 보낸 사람의 Member ID

    private String sellerEmail;      // 판매자 Member ID
    private String buyerEmail;       // 구매자 Member ID
    ...
    @Builder
    public ChatMessage(Long roomId, Long senderId, String sellerEmail, String buyerEmail,
